...
from triqs_dft_tools.converters.converter_tools import ConverterTools
        ...
        if mpi.is_master_node():
            with HDFArchive(self.hdf_file, 'a') as archive:
                ...
                things_to_save = ['energy_unit', 'n_k', 'k_dep_projection', 'SP', 'SO', 'charge_below', 'density_required',
                              ...
                              'u_total','rot_mat_time_inv', 'n_reps', 'dim_reps', 'T', 'n_orbitals', 'proj_mat', 'bz_weights',
                              'hopping','n_inequiv_shells', 'corr_to_inequiv', 'inequiv_to_corr', 'kpt_weights', 'kpts', 
                              'dft_code']
                if self.bloch_basis:
